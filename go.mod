...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dsql/auth v1.1.16
	...
	go.temporal.io/api v1.62.8-0.20260403191142-88fa428ba0df
...
require github.com/aws/aws-sdk-go-v2/service/internal/endpoint-discovery v1.11.17 // indirect
